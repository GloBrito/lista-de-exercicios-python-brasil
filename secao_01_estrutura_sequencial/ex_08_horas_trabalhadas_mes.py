...
def calcular_salario():
    ...
    horas_trabalhadas_mes = float(input('Quantas horas você tabalha por mês?'))
    salario_por_mes = salario_por_hora * horas_trabalhadas_mes 
    print(f'Seu salário desse mês é {salario_por_mes:.2f}')
